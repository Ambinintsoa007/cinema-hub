...
public class MovieMapper {
  ...
  public Movie toDomain(MovieEntity entity) {
    Set<hei.school.cinema.model.Genre> genres =
        entity.getGenres().stream()
            .map(mg -> toDomainGenre(mg.getId().getGenre()))
  ...
  public MovieResponse toDto(Movie movie) {
    return new MovieResponse(
        ...
        movie.getGenres().stream().map(this::toDtoGenre).collect(Collectors.toList()));
  }
  ...
  public hei.school.cinema.gen.model.Genre toDtoGenre(hei.school.cinema.model.Genre domainGenre) {
    return hei.school.cinema.gen.model.Genre.valueOf(domainGenre.name());
  }

  public hei.school.cinema.model.Genre toDomainGenre(hei.school.cinema.gen.model.Genre dtoGenre) {
    return hei.school.cinema.model.Genre.valueOf(dtoGenre.getValue());
  }

  public Set<hei.school.cinema.model.Genre> toDomainGenres(
      Set<hei.school.cinema.gen.model.Genre> dtoGenres) {
