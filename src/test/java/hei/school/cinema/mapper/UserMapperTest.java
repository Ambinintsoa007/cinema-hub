...
class UserMapperTest {
    ...
    void toDto_should_not_expose_password() {
        ...
        assertThat(response.getRole())
                .isEqualTo(hei.school.cinema.endpoint.rest.dto.UserRole.EMPLOYEE);
    ...
    void enum_mappings_should_handle_null() {
        assertThat(
                userMapper.toDomainRole(
                        (hei.school.cinema.endpoint.rest.dto.UserRole) null))
                .isNull();

        assertThat(
                userMapper.toDomainStatus(
                        (hei.school.cinema.endpoint.rest.dto.UserStatus) null))
                .isNull();

        assertThat(
                userMapper.toEntityRole(null))
                .isNull();

        assertThat(
                userMapper.toEntityStatus(null))
                .isNull();
    }
}